<template>
  <svg
    ...
    width="15.151px"
    height="21.654px"
    viewBox="0 0 15.151 21.654"
    enable-background="new 0 0 15.151 21.654"
    xml:space="preserve"
  >
    <g id="Glyph_copy_2">
      <path
        fill="#6c9c5a"
        d="M11.004,7.835c0-1.883-1.538-3.414-3.43-3.414c-1.889,0-3.431,1.531-3.431,3.414
		c0,1.884,1.542,3.419,3.431,3.419C9.466,11.254,11.004,9.719,11.004,7.835z"
      />
      <path
        fill="#6c9c5a"
        d="M7.574,21.654l1.388-1.817c1.455-1.925,6.189-8.469,6.189-12.049C15.151,3.132,12.106,0,7.574,0
