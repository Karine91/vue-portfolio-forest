<template>
  <svg
    ...
    width="18.164px"
    height="13.922px"
    viewBox="0 0 18.164 13.922"
    enable-background="new 0 0 18.164 13.922"
    xml:space="preserve"
  >
    <g>
      <path
        fill="#FFFFFF"
        d="M17.836,3.516L9.352,12l-1.594,1.594c-0.211,0.211-0.504,0.328-0.797,0.328s-0.586-0.117-0.797-0.328
